(function() {
    ...
    angular
        ...
        .controller('NoClasificadosPrincipalController', NoClasificadosPrincipalController);

    NoClasificadosPrincipalController.$inject = ['$rootScope', '$timeout', 'SweetAlert', '$modal', 'tablaDatosService', 'CatMunicipios', 'VistaLocalidadesPredios', 'VistaColoniasPredios', 'VistaPrediosNoClasificados', 'TdPrediosInventario'];

    function NoClasificadosPrincipalController($rootScope, $timeout, SweetAlert, $modal, tablaDatosService, CatMunicipios, VistaLocalidadesPredios, VistaColoniasPredios, VistaPrediosNoClasificados, TdPrediosInventario ) {
            ...
            function inicia() {
                  ...
                  tablaDatosService.obtiene_datos_tabla(VistaPrediosNoClasificados, vm.tablaListaPredios)
            ...
            function cambiarPagina() {
                  ...
                  if(vm.tablaListaPredios.totalElementos > 0)
                  {
                        tablaDatosService.cambia_pagina(VistaPrediosNoClasificados, vm.tablaListaPredios)
                        .then(function(respuesta) {
