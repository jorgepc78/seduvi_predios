(function() {
    ...
    angular
        ...
        ModalNuevoRegistroController.$inject = ['$modalInstance', 'registroEditar', 'CatEstatusPredioDisponibles', 'CatEstatusReserva', 'CatEstatusTitulo', 'CatModalidadPrograma', 'CatSituacionFinanciera', 'CatSituacionJuridica', 'CatTipoDocumentoAsignacion'];

    function ModalNuevoRegistroController($modalInstance, registroEditar, CatEstatusPredioDisponibles, CatEstatusReserva, CatEstatusTitulo, CatModalidadPrograma, CatSituacionFinanciera, CatSituacionJuridica, CatTipoDocumentoAsignacion) {
